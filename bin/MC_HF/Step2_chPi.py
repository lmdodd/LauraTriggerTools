...
hist_ptb3.SetTitle('gen pion Pt/(TPGPt)  vs TPG iEta')
hist_ptb3.Draw("pE1")
...
legend1.AddEntry(hist_ptb1, "ch. Pion Pt=5-20 GeV")
legend1.AddEntry(hist_ptb2, "ch. Pion Pt=20-30 GeV")
legend1.AddEntry(hist_ptb3, "ch. Pion Pt=30-50 GeV")
legend1.AddEntry(hist_ptb4, "ch. Pion Pt>50 GeV")
legend1.Draw("same")
