...
hist_ptb0.GetXaxis().SetTitle("Pi0 TPG Eta")
hist_ptb0.GetYaxis().SetTitle("Gen/Pi0 TPG Value")
hist_ptb0.GetYaxis().SetRangeUser(0.7,2.1)
hist_ptb0.SetTitle('genPt/TPGPt vs Pi0 TPG Eta')
hist_ptb0.Draw("pE1")
...
legend1.AddEntry(hist_ptb0, "Pi0 TPG Pt=10 GeV")
legend1.AddEntry(hist_ptb1, "Pi0 TPG Pt=15 GeV")
legend1.AddEntry(hist_ptb2, "Pi0 TPG Pt=20 GeV")
legend1.AddEntry(hist_ptb3, "Pi0 TPG Pt=25 GeV")
legend1.AddEntry(hist_ptb4, "Pi0 TPG Pt=30 GeV")
legend1.AddEntry(hist_ptb5, "Pi0 TPG Pt=35 GeV")
legend1.AddEntry(hist_ptb6, "Pi0 TPG Pt=40 GeV")
legend1.AddEntry(hist_ptb7, "Pi0 TPG Pt=45 GeV")
legend1.AddEntry(hist_ptb8, "Pi0 TPG Pt=50 GeV")
legend1.Draw("same")
saveas=saveWhere+'pi0_SF_trigger.png'
