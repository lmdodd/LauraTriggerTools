...
hist_ptb0.GetXaxis().SetTitle("Pi+ TPG Eta")
hist_ptb0.GetYaxis().SetTitle("Gen/Pi+ TPG Value")
hist_ptb0.GetYaxis().SetRangeUser(0.7,3)
hist_ptb0.SetTitle('genPt/TPGPt vs Pi+ TPG Eta')
hist_ptb0.Draw("pE1")
...
legend1.AddEntry(hist_ptb0, "Pi+ TPG Pt=10 GeV")
legend1.AddEntry(hist_ptb1, "Pi+ TPG Pt=15 GeV")
legend1.AddEntry(hist_ptb2, "Pi+ TPG Pt=20 GeV")
legend1.AddEntry(hist_ptb3, "Pi+ TPG Pt=25 GeV")
legend1.AddEntry(hist_ptb4, "Pi+ TPG Pt=30 GeV")
legend1.AddEntry(hist_ptb5, "Pi+ TPG Pt=35 GeV")
legend1.AddEntry(hist_ptb6, "Pi+ TPG Pt=40 GeV")
legend1.AddEntry(hist_ptb7, "Pi+ TPG Pt=45 GeV")
legend1.AddEntry(hist_ptb8, "Pi+ TPG Pt=50 GeV")
legend1.Draw("same")
saveas=saveWhere+'pipl_SF_trigger.png'
