...
ntuple_uncorr = ntuple_file.Get("tree/Ntuple")
...
compare_efficiencies(ntuple, 'recoPt',  100, [40, 0, 300],
                    'jet_pt_trg100',
                     "Jet 100 efficiency", "RECO p_{T} (GeV)",True)
compare_efficiencies(ntuple, 'recoPt',  150, [40, 0, 300],
                     'jet_pt_trg150',
                     "Jet 150 efficiency", "RECO p_{T} (GeV)",True)
compare_efficiencies(ntuple, 'recoPt',  200, [40, 0, 300],
                     'jet_pt_trg200',
                     "Jet 200 efficiency", "RECO p_{T} (GeV)",True)
compare_efficiencies(ntuple, 'recoPt',  30, [40, 0, 200],
                     'jet_pt_trg30',
                     "Jet 30 efficiency", "RECO p_{T} (GeV)",True)
compare_efficiencies(ntuple, 'recoPt',  40, [40, 0, 200],
                     'jet_pt_trg40',
                     "Jet 40 efficiency", "RECO p_{T} (GeV)",True)
compare_efficiencies(ntuple, 'recoPt',  50, [40, 0, 200],
                     'jet_pt_trg50',
                     "Jet 50 efficiency", "RECO p_{T} (GeV)",True)
compare_efficiencies(ntuple, 'recoPt',  60, [40, 0, 200],
                     'jet_pt_trg60',
                     "Jet 60 efficiency", "RECO p_{T} (GeV)",True)
compare_efficiencies(ntuple, 'recoPt',  70, [40, 0, 200],
                    'jet_pt_trg70',
                   "Jet 70 efficiency", "RECO p_{T} (GeV)",True)

# Resolutions
ntuple.Draw("(recoPt - (%0.2f * l1gPt))/recoPt>>l1gPtRes(150, -2, 1)" % L1G_CALIB_FACTOR, "l1gMatch && recoPt > 50 && abs(recoEta) < 3.0", "goff")
...
ntuple.Draw("(recoPt - l1Pt)/recoPt>>l1PtRes(150, -2, 1)", "l1Match && recoPt > 50 && abs(recoEta)<3.0", "goff")
...
ntuple.Draw("recoPt-l1gPt:nPVs>>l1g","recoPt>30 &&recoPt<40 && recoEta<3.0 && l1gMatch","BOX")
...
ntuple.Draw("recoPt-l1Pt:nPVs>>l1","recoPt>30 && recoPt<40 && recoEta<3.0 && l1Match","BOX")
...
ntuple_uncorr.Draw("recoPt-l1gPt:nPVs>>l1gu","recoPt>30 && recoPt<40 && recoEta<3.0 && l1gMatch","BOX")
...
ntuple.Draw("(recoPt - l1Pt)/recoPt>>l1PtRes(150, -2, 1)", "l1Match && recoPt > 30 && abs(recoEta)<3.0", "goff")
l1PtRes = ROOT.gDirectory.Get("l1PtRes")
l1PtRes.SetLineColor(ROOT.EColor.kRed)
l1PtRes.Scale(1/l1PtRes.Integral())
l1gPtRes.Draw()
...
#>>>>>>>>Eta Res
ntuple.Draw("(recoEta - l1gEta)>>l1gEtaRes(100, -2, 2)", "l1gMatch && recoPt > 20 && l1gPt > 20 && abs(recoEta) < 3.0 ", "goff")
...
ntuple.Draw("(recoEta - l1Eta)>>l1EtaRes(100, -2, 2)", "l1Match && recoPt > 20", "goff")
...
#>>>>>>>>Phi Res
ntuple.Draw("(recoPhi - l1gPhi)>>l1gPhiRes(100, -2, 2)", "l1gMatch && recoPt > 20 && l1gPt > 20 && abs(recoEta) < 3.0", "goff")
...
ntuple.Draw("(recoPhi - l1Phi)>>l1PhiRes(100, -2, 2)", "l1Match && recoPt > 20", "goff")
